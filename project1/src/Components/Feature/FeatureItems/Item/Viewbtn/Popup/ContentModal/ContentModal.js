...
import './style.css'
import ContentModalImages from './ContentModalImages/ContentModalImages'
import ContentModalDesc from './ContentModalDesc/ContentModalDesc'
  ...
  render() {
    ...
    return (
      ...
      <div className='ContentModal'>
        <ContentModalImages contentModel={products[0]}/>
        <ContentModalDesc contentModel={products[0]}/>
      </div>
      </>
    )
  }
